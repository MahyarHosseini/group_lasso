#Credit for this module belongs to Fabian Pedregosa (GitHub: https://gist.github.com/fabianp)
#Link to the module's owner on GitHub https://gist.github.com/fabianp/1423373
            ...
            if len(g) < 2:
                ...
                if alpha < linalg.norm(X_residual, 2):
                    initial_guess[i] = optimize.newton(f, initial_guess[i], df, tol=.5,
                                args=(qp ** 2, eigvals, alpha), maxiter = max_iter)
